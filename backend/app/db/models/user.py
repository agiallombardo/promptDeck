...
class User(Base):
    ...
    llm_openai_base_url: Mapped[str | None] = mapped_column(String(512), nullable=True)
    llm_anthropic_base_url: Mapped[str | None] = mapped_column(String(512), nullable=True)
    llm_litellm_base_url: Mapped[str | None] = mapped_column(String(512), nullable=True)
    llm_openai_key_encrypted: Mapped[str | None] = mapped_column(Text(), nullable=True)
    llm_anthropic_key_encrypted: Mapped[str | None] = mapped_column(Text(), nullable=True)
    llm_litellm_key_encrypted: Mapped[str | None] = mapped_column(Text(), nullable=True)
